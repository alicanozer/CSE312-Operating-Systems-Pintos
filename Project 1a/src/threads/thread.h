...
/* calısan threadin priority'si return edilir.*/
int thread_get_priority (void); 
/* calısan threadin pri seti yapılır*/
...
/*PART 1*/
/* threadlerin ticklerinin karsilastırilmasi*/
